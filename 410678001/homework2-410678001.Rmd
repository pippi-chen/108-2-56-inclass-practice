...
time_place <- course$course$time_place
...
course_update$course[["teacher"]] <- "紀學檜老師"
...
Pikachu <- list(
  dex = Gamemaster$pokemon[[27]]$dex, 
  speciesName = Gamemaster$pokemon[[27]]$speciesName, 
  speciesId = Gamemaster$pokemon[[27]]$speciesId, 
  baseStates = list(
    atk = Gamemaster$pokemon[[27]]$baseStats$atk, 
    def = Gamemaster$pokemon[[27]]$baseStats$def, 
    hp = Gamemaster$pokemon[[27]]$baseStats$hp
  ), 
  types = Gamemaster$pokemon[[27]]$types, 
  fastMoves = Gamemaster$pokemon[[27]]$fastMoves, 
  chargeMoves = Gamemaster$pokemon[[27]]$chargedMoves, 
  legacyMoves = Gamemaster$pokemon[[27]]$legacyMoves, 
  defaultIVs = list(
    cp1500 = Gamemaster$pokemon[[27]]$defaultIVs$cp1500, 
    cp2500 = Gamemaster$pokemon[[27]]$defaultIVs$cp2500
  )
)
...
selected_stats <- c(Pikachu$baseStates$atk, Pikachu$baseStates$def, Pikachu$baseStates$hp)
Pikachu_stats <- as.numeric(selected_stats)
...
Jigglypuff <- list(
  dex = Gamemaster$pokemon[[46]]$dex, 
  speciesName = Gamemaster$pokemon[[46]]$speciesName, 
  speciesId = Gamemaster$pokemon[[46]]$speciesId, 
  baseStates = list(
    atk = Gamemaster$pokemon[[46]]$baseStats$atk, 
    def = Gamemaster$pokemon[[46]]$baseStats$def, 
    hp = Gamemaster$pokemon[[46]]$baseStats$hp
  ), 
  types = Gamemaster$pokemon[[46]]$types, 
  fastMoves = Gamemaster$pokemon[[46]]$fastMoves, 
  chargeMoves = Gamemaster$pokemon[[46]]$chargedMoves, 
  legacyMoves = Gamemaster$pokemon[[46]]$legacyMoves, 
  defaultIVs = list(
    cp1500 = Gamemaster$pokemon[[46]]$defaultIVs$cp1500, 
    cp2500 = Gamemaster$pokemon[[46]]$defaultIVs$cp2500
  )
)
